...
const App = () => {
  // State to control the sidebar expanded view
  ...
  const [notes, setNotes] = useState([
    { id: 1, title: "Sample Note 1", text: "This is a sample note 1" },
    { id: 2, title: "Sample Note 2", text: "This is the second sample note" }
]);
