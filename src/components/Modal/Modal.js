...
const Modal = ({note, closeModal, updateNote}) => {
    ...
    const [title, setTilte] = useState(note ? note.title : "");
  ...
  return (
    <div className={`modal ${note ? "openModal" : ""}`} onClick={handleoutsideClick}>
                <div className="modal-content">
                    <div className="form-container">
                        <form className="form" id="modal-form">
                            <div className="note-title">
                                <input type="text" placeholder="Title" value={title} onChange={(e) => setTilte(e.target.value)} />
                                <span className="material-symbols-outlined note-pin">keep</span>
                            </div>
                            <div className="note-text">
                                <input type="text" placeholder="Take a note..." value={text} onChange={(e) => setText(e.target.value)}/>
                            </div>
